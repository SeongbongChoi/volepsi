...
namespace volePSI_Tests
{
    ...
    oc::TestCollection Tests([](oc::TestCollection& t) {
        ...
        // t.add("RelicPaxos_buildRow_Test         ", RelicPaxos_buildRow_Test);
        // t.add("RelicPaxos_solve_Test            ", RelicPaxos_solve_Test);
        // t.add("RelicPaxos_solve_g1_Test         ", RelicPaxos_solve_g1_Test);
        // t.add("RelicPaxos_solve_mtx_Test        ", RelicPaxos_solve_mtx_Test);
        // t.add("RelicPaxos_solve_gap_Test         ", RelicPaxos_solve_gap_Test);
        // t.add("RelicPaxos_solve_rand_Test        ", RelicPaxos_solve_rand_Test);
        // t.add("RelicPaxos_solve_rand_gap_Test        ", RelicPaxos_solve_rand_gap_Test);
                                           
        // t.add("RelicPaxos_g1_operations_Test             ", RelicPaxos_g1_operations_Test);
        // t.add("RelicPaxos_bn_hash_Test          ", RelicPaxos_bn_hash_Test);
        // t.add("RelicPaxos_memory_management_Test        ", RelicPaxos_memory_management_Test);

        // t.add("RelicPaxos_experiment       ", RelicPaxos_experiment);
        // t.add("RelicPaxos_benchmark   ", RelicPaxos_benchmark);


        
        t.add("LPsi_empty_test   ", LPsi_empty_test);
        t.add("LPsi_partial_test   ", LPsi_partial_test);
        t.add("LPsi_full_test   ", LPsi_full_test);
        t.add("LPsi_perf_test   ", LPsi_perf_test);
